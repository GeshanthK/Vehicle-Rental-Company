...
public class SaturdayHours extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_saturday_hours);
    }
...
//        });
        ...
        hashMap.put("day","Saturday");
        hashMap.put("open", edit_open.getText().toString());
        hashMap.put("close", edit_close.getText().toString());
        daoEmployeeHours.update("-MpFEkSQpYqi8hHSSh0i",hashMap).addOnSuccessListener(suc->{
