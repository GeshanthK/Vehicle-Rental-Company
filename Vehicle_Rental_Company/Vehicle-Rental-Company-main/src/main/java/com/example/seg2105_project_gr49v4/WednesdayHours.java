...
public class WednesdayHours extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wednesday_hours);
    }
...
//        });
        ...
        hashMap.put("day","Wednesday");
        hashMap.put("open", edit_open.getText().toString());
        hashMap.put("close", edit_close.getText().toString());
        daoEmployeeHours.update("-MpFEj90qACwYc0mjh5y",hashMap).addOnSuccessListener(suc->{
