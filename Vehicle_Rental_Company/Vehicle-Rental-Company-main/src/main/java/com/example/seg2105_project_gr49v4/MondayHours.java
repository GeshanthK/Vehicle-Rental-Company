...
public class MondayHours extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_monday_hours);
    }
...
//        });
        ...
        daoEmployeeHours.update("-MpEtKoQwQGSHQwRGl22",hashMap).addOnSuccessListener(suc->{
