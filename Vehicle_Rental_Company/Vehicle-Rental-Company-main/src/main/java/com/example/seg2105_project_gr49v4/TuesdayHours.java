...
public class TuesdayHours extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tuesday_hours);
    }
...
//        });
        ...
        hashMap.put("day","Tuesday");
        hashMap.put("open", edit_open.getText().toString());
        hashMap.put("close", edit_close.getText().toString());
        daoEmployeeHours.update("-MpFEfYRQNlzUca4cP3c",hashMap).addOnSuccessListener(suc->{
